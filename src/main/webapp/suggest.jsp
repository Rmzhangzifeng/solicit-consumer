   ...
   <div class="pb-container-main pb-after-clear"> 
    ...
    <div class="pb-main pb-mt20"> 
     <div class="usr-l pb-fl"> 
      <div class="head"> 
       <a href="http://www.lanrenzhijia.com/"" title="更改头像"> <img src="images/head_10001_4c59b035cf_100.jpg" alt="叫醒闹钟" id="userDetailHead" /> </a> 
      </div> 
      ...
      <div class="nav-cnt pb-size-small"> 
       <ul> 
        <li class=""><a id="homepage" link="member_index.html" class="goto" href="javascript:void(0);">作者主页</a></li> 
