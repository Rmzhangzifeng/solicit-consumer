     ...
     <div class="cnt"> 
      ...
      <div> 
       ...
       <div class="bdsharebuttonbox pb-fl" style="margin-top:3px;">
        ...
        <a title="分享到微信" href="http://www.lanrenzhijia.com/"" class="bds_weixin" data-cmd="weixin"></a>
        <a title="分享到新浪微博" href="http://www.lanrenzhijia.com/"" class="bds_tsina" data-cmd="tsina"></a>
        <a title="分享到QQ好友" href="http://www.lanrenzhijia.com/"" class="bds_sqq" data-cmd="sqq"></a>
       </div> 
       <script>
