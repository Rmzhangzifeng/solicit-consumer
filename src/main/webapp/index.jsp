...
<div class="pb-container">
    <div class="pb-container-main pb-after-clear">
        ...
        <div class="pb-main pb-mt10">
            <div id="bSlideBox" class="pb-main slideBox">
                <ul class="items" id="myspread">
                    <li><a target="_blank" onclick="Sys.commStat(46);" href="#"><img
                            src="images/banner_10001_3f4dac09bb.jpg" alt="开学季 开学梦想 开学展望 开学励志 九月开学 青春梦想"/></a></li>
                    <li><a target="_blank" onclick="Sys.commStat(47);" href="#"><img
                            src="images/banner_10001_300a22a90b.jpg" alt="倾听世界,世界这么大,我想去走走"/></a></li>
                </ul>
            </div>
        </div>
        <script>
        /*    $(document).ready(function () {
            ...
            $(function () {
                //初始数据填充
                $.ajax({
                    url: "<%=request.getContextPath()%>/Spread/querySpread",
                    type: "post",
                    dataType: "json",
                    success: function (data) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            spreadmsg += "<li><a target='_blank' onclick='点击' href='#'>" +
                                "<img src='" + data[i].solicitarticlescover + "' alt='" + data[i].solicitarticlestitle + "' style='width: 1050px; height: 354px;'/></a></li>"
                        }

                        $("#myspread").html(spreadmsg)
                        //填充结束
                        //开启轮播
                        $('#bSlideBox').slideBox({
                            duration: 0.7,
        ...
        <div class="pb-main pb-mt20">
            ...
            <div class="idx-ycwz-1 pb-mt20 pb-after-clear">
                <a href="news_detail.html?-10" class="pb-iblock pb-fl"> <img src="images/essay_10001_f6d8065f91.jpg"
                                                                             class="pb-block" alt="本期征文比赛,你如何看待高中生恋爱"/>
                </a>
                <div class="pb-iblock pb-fl d1">
                    <h6><a href="news_detail.html?-10" class="pb-clr1 pb-size-big">本期征文比赛 | <span>你如何看待高中生恋爱</span></a>
                    </h6>
                    <div class="pb-line2 pb-mt5" style="border:0;">
                    </div>
                    <ul>
                        <li class="pb-mt20"><a href="news_detail.html?-10-72"><img
                                src="images/essay_10001_8dd1e515f2.jpg" class="pb-fl" alt="本期征文比赛文章,一种不成熟的爱"/></a> <a
                                href="news_detail.html?-10-72" class="pb-fl rt">一种不成熟的爱 / 木目心</a>
                            <p class="pb-iblock">高中，对于很多人来说，是一段带着自己的大学梦储备能量的征途吧，为的只是在最后一场战—</p></li>
                        <li class="pb-mt20"><a href="news_detail.html?-10-73"><img
                                src="images/essay_10001_bf886ee0c8.jpg" class="pb-fl" alt="本期征文比赛文章,高中.成长"/></a> <a
                                href="news_detail.html?-10-73" class="pb-fl rt">高中.成长 / 小小一轮弯</a>
                            <p class="pb-iblock">高中时期学业繁重，前途迷茫，空虚与不被理解成了早恋原因。当我们无法从长辈那得到理解与</p></li>
                        <li class="pb-mt20"><a href="news_detail.html?-10-74"><img
                                src="images/essay_10001_6e99eb35e6.jpg" class="pb-fl" alt="本期征文比赛文章,多感激，那是你"/></a> <a
                                href="news_detail.html?-10-74" class="pb-fl rt">多感激，那是你 / Someone.</a>
                            <p class="pb-iblock">“看着今天的朝阳又是金碧辉煌一大片，我突然很想吃姥姥家的炸鸡排，外焦里嫩，老大一个，</p></li>
                    </ul>
                </div>
                <!--右侧我要投稿公共部分-->
                <div class="pb-iblock pb-fr pb-after-clear pb-main-side">
                    ...
                    <h6 class="pb-mt15"><span class="pb-clr1 pb-size-normal">已投稿 <i class="tougao">2</i></span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="javascript:Sys.showRuleDiv();" class="pb-clr1 pb-size-small pb-underline">获奖规则</a></h6>
            ...
            <div class="idx-ycwz-1 pb-mt50 pb-after-clear">
                <div class="idx-last-board pb-fl">
                    <a href="news_detail.html?-9"><img src="images/essay_10001_2c1098e1a2.jpg" class="pb-block"
                                                       alt="上期征文比赛,上期有奖征文, 开学与青春或梦想"/></a>
                ...
                <div class="pb-iblock pb-fl d1">
                    ...
                    <ul class="pb-mt15 rank">
                        <li class="pb-iblock pb-mt8"><span class="pb-fl pb-mt10 no">1</span> <a href="/user-10348">
                            <dl class="pb-fl">
                                <dt>
                                    <img src="images/head_10348_57fbdd4d36.jpg" class="pb-block" alt="参加征文比赛作者,小红楼"/>
                                </dt>
                                <dd>
                                    小红楼
                                </dd>
                            </dl>
                        </a> <a href="news_detail.html?-9-58"
                                class="pb-fl pb-block pb-size-normal title">开学，路过了我整个青春</a> <span class="pb-fr dollar">$30</span>
                        </li>
                        <li class="pb-iblock pb-mt8"><span class="pb-fl pb-mt10 no">2</span> <a href="/user-10393">
                            <dl class="pb-fl">
                                <dt>
                                    <img src="images/default.gif" class="pb-block" alt="参加征文比赛作者,橙子"/>
                                </dt>
                                <dd>
                                    橙子
                                </dd>
                            </dl>
                        </a> <a href="news_detail.html?-9-62" class="pb-fl pb-block pb-size-normal title">那一年的散伙饭
                            是我们无</a> <span class="pb-fr dollar">$20</span></li>
                        <li class="pb-iblock pb-mt8"><span class="pb-fl pb-mt10 no">3</span> <a href="/user-10394">
                            <dl class="pb-fl">
                                <dt>
                                    <img src="images/head_10394_2448d2c4b3.jpg" class="pb-block" alt="参加征文比赛作者,马琳娜55"/>
                                </dt>
                                <dd>
                                    马琳娜55
                                </dd>
                            </dl>
                        </a> <a href="news_detail.html?-9-63" class="pb-fl pb-block pb-size-normal title">寻常过往，转瞬成殇</a>
                            <span class="pb-fr dollar">$10</span></li>
                    </ul>
                </div>
            ...
            <div class="idx-wqzt pb-mt15 pb-after-clear">
                <ul class="idx-wqzt pb-mt10">
                    <li>
                        <dl>
                            <dt>
                                <a href="news_detail.html?-8"><img alt="毕业季 校园时代 七月校园 离别气息"
                                                                   src="images/essay_10001_b959107f8b.jpg"/></a>
                            </dt>
                            <dd>
                    ...
                    <li>
                        <dl>
                            <dt>
                                <a href="news_detail.html?-7"><img alt="去旅行，装满爱，夏天旅行，夏天旅游"
                                                                   src="images/essay_10001_ed83e14b8a.png"/></a>
                            </dt>
                            <dd>
                    ...
                    <li>
                        <dl>
                            <dt>
                                <a href="news_detail.html?-6"><img
                                        alt="有奖征文，征文比赛，享笑网有奖征文比赛，第六期有奖征文，有奖征文之飘着淡淡粽香的父亲节，征文专题之飘着淡淡粽香的父亲节，端午节和父亲节感想，端午节感想，父亲节感想"
                                        src="images/essay_10001_183a4e95ad.jpg"/></a>
                            </dt>
                            <dd>
                    ...
                    <li>
                        <dl>
                            <dt>
                                <a href="news_detail.html?-5"><img
                                        alt="有奖征文，征文比赛，享笑网有奖征文比赛，第五期有奖征文，有奖征文之东方之星之痛，征文专题之东方之星之痛，东方之星沉船之痛，东方之星沉船"
                                        src="images/essay_10001_8d58c19a60.jpg"/></a>
                            </dt>
                            <dd>
                    ...
                    <li style="margin-right:0;">
                        <dl>
                            <dt>
                                <a href="news_detail.html?-4"><img
                                        alt="有奖征文，征文比赛，享笑网有奖征文比赛，第四期有奖征文，有奖征文之你和你的城，征文专题之你和你的城"
                                        src="images/essay_10001_0ba5781188.jpg"/></a>
                            </dt>
                            <dd>
            ...
            <h3 class="idx-qtsj-t pb-mt50">
                ...
                <a href="pic.html"> <span class="chn">倾听世界</span> <br/> <span class="eng">LISTEN TO THE WORLD</span>
                </a></h3>
            <div class="idx-qtsj pb-mt20 pb-after-clear">
                <ul>
                    <li><a href="pic_detail.html?1"> <img src="images/qing_10001_7b053ee001_310.jpg" class="pb-block"
                                                          style="width:200px;" alt="美女,清纯唯美写真合集"/> </a>
                    ...
                    <li><a href="pic_detail.html?3"> <img src="images/qing_10001_2278c48f96_310.jpg" class="pb-block"
                                                          style="width:200px;" alt="旅行,也许我就是一块老墨"/> </a>
                        <table class="pb-opac70">
                            <tbody>
                            <tr>
                                <td class="tle">旅行</td>
                    ...
                    <li><a href="pic_detail.html?4"> <img src="images/qing_9999_6963913fb8_310.jpg" class="pb-block"
                                                          style="width:200px;" alt="搞笑,证件照"/> </a>
                        <table class="pb-opac70">
                            <tbody>
                            <tr>
                                <td class="tle">搞笑</td>
                    ...
                    <li><a href="pic_detail.html?6"> <img src="images/qing_10001_3f5af7636f_310.jpg" class="pb-block"
                                                          style="width:200px;" alt="性感,享笑网2015-5-30#325806#"/> </a>
                        <table class="pb-opac70">
                            <tbody>
                            <tr>
                                <td class="tle">性感</td>
                    ...
                    <li style="margin-right:0;"><a href="pic_detail.html?7"> <img
                            src="images/qing_10001_5502d62ca8_310.jpg" class="pb-block" style="width:200px;"
                            alt="情感,爱情就是一百多年的孤寂"/> </a>
                        <table class="pb-opac70">
                            <tbody>
                            <tr>
                                <td class="tle">情感</td>
                    ...
                    <li><a href="pic_detail.html?10"> <img src="images/qing_10001_bcf83a76ac_310.jpg" class="pb-block"
                                                           style="width:200px;" alt="艺术,中国书法家【郝天明】书法新作(妙笔生辉"/> </a>
                        <table class="pb-opac70">
                            <tbody>
                            <tr>
                                <td class="tle">艺术</td>
                    ...
                    <li><a href="pic_detail.html?13"> <img src="images/qing_10001_8b07d372b1_310.jpg" class="pb-block"
                                                           style="width:200px;" alt="漫画,享笑网2015-6-8#529409#"/> </a>
                        <table class="pb-opac70">
                            <tbody>
                            <tr>
                                <td class="tle">漫画</td>
                    ...
                    <li><a href="pic_detail.html?15"> <img src="images/qing_10001_7610be26ad_310.jpg" class="pb-block"
                                                           style="width:200px;" alt="超萌,步调一致"/> </a>
                        <table class="pb-opac70">
                            <tbody>
                            <tr>
                                <td class="tle">超萌</td>
                    ...
                    <li><a href="pic_detail.html?22"> <img src="images/qing_9999_578544d87f_310.jpg" class="pb-block"
                                                           style="width:200px;"
                                                           alt="回忆,如果你喜欢的人不喜欢你,那么就算全世界的人都喜欢你 也还是会觉得很孤单吧。"/> </a>
                        <table class="pb-opac70">
                            <tbody>
                            <tr>
                                <td class="tle">回忆</td>
                    ...
                    <li style="margin-right:0;"><a href="pic_detail.html?24"> <img
                            src="images/qing_10001_4f8ce7bfa4_310.jpg" class="pb-block" style="width:200px;"
                            alt="清新,最大的遗憾"/> </a>
                        <table class="pb-opac70">
                            <tbody>
                            <tr>
            ...
            <div class="idx-mryx pb-mt20 pb-after-clear">
                ...
                <div class="d1 pb-fl d1-2">
                    ...
                    <a href="/jokes?priority=pop" class="tle pb-fl pb-clr1">笑话排行&nbsp;&nbsp;|&nbsp;&nbsp; <span
                            class="pb-clr2">更多</span></a>
                    <ul class="pb-mt15 pb-fl pb-size-normal">
            ...
            <div class="idx-jxed pb-mt20 pb-after-clear">
                    ...
                    <ul>
                        <li><img class="pb-fl" src="images/b_jxed_l1.jpg" alt="把耳朵叫醒,爱他们的时候我们像条狗,扣子"/>
                            <dl class="pb-fl">
                                ...
                                <dd class="ap">
                                    <span class="auplayer" id="auplayer_241"
                                          f="L3B1YmxpYy9wbGF5ZXIvMjAxNTA1L2F0ZHNod214dGcubXAz&gt;" a="扣子"
                                          t="爱他们的时候我们像条狗"></span>
                                </dd>
                            </dl>
                        </li>
                        <li class="pb-mt40"><img class="pb-fl" src="images/b_jxed_l2.jpg"
                                                 alt="把耳朵叫醒,爱你的第九年,这是你不必详知的事情,NJ楚璇"/>
                            <dl class="pb-fl">
                                <dt>
                                ...
                                <dd class="ap">
                                    <span class="auplayer" id="auplayer_240"
                                          f="L3B1YmxpYy9wbGF5ZXIvMjAxNTA1L2FpbmlkZWRpaml1bmlhbi5tcDM=&gt;" a="NJ楚璇"
                                          t="爱你的第九年,这是你不必详知的事情"></span>
                                </dd>
                            </dl>
                        </li>
                    </ul>
                ...
                <div class="d2 pb-fr">
                    <dl>
                        <dt>
                            <a href="/weekly-1-2"> <img src="images/post_10001_c1be1e419b.jpg"
                                                        alt="征文比赛,有奖征文,第二期：回首这匆匆十年"/> </a>
                        </dt>
        ...
        <div class="pb-footer-wp">
            <div class="pb-main pb-footer-cnt pb-size-small">
                ...
                <ul class="pb-fr">
                    ...
                    <li>
                        <a href="http://wpa.qq.com/msgrd?v=1&amp;uin=2338601847&amp;site=www.sharesmile.cn&amp;menu=yes">版权声明</a>
                    </li>
                    <li>
                        <a href="http://wpa.qq.com/msgrd?v=1&amp;uin=2338601847&amp;site=www.sharesmile.cn&amp;menu=yes">客服中心</a>
                    </li>
                    <li>
                        <a href="http://wpa.qq.com/msgrd?v=1&amp;uin=2338601847&amp;site=www.sharesmile.cn&amp;menu=yes">联系我们</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="ssretotop" id="goTopButton">
        <div class="SG-sidecont">
            ...
            <a id="retotop" class="pb-icons" href="javascript:void(0)" style="visibility: visible;"
               title="点击我 坐飞机到顶部"></a>
...
<noscript>
    <a href="http://www.51.la/?15502332" target="_blank"><img alt="我要啦免费统计" src="images/15502332.asp"
                                                              style="border:none"/></a>
</noscript>
