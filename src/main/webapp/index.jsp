              ...
              return false;"> 
                ...
                <div class="pb-main pb-mt10"> 
                    <div id="bSlideBox" class="pb-main slideBox"> 
                        <ul class="items"> 
                            <li><a target="_blank" onclick="Sys.commStat(46);" href="#"><img src="images/banner_10001_3f4dac09bb.jpg" alt="开学季 开学梦想 开学展望 开学励志 九月开学 青春梦想" /></a></li> 
                            <li><a target="_blank" onclick="Sys.commStat(47);" href="#"><img src="images/banner_10001_300a22a90b.jpg" alt="倾听世界,世界这么大,我想去走走" /></a></li> 
                        </ul> 
                    </div> 
                </div> 
                <script>
